...
# siapkan 1 gambar di folder yg smaa untuk diconvert menjadi sketsa pensil
...
img = "ponyo.jpeg" # nama file input
...
def dodge(front,back):
    ...
    # kalau gambarnya lebih besar dari 255 bit /px maka akan di convert jadi 255
...
r = dodge(blur,gray)
#untuk convert gambarnya(dengan mengaplikasikan bkur&black&white tadi)
